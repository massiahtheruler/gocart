...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link href={`/product/${product.id}`} className="group mx-auto block">
      <div className="product-stage glass-sheen flex h-40 items-center justify-center rounded-[1.4rem] px-4 sm:h-68 sm:w-60">
        <Image
          width={500}
          height={500}
      ...
      <div className="max-w-60 pt-3 text-sm text-slate-800">

  ...
  const linkSections = [
    {
      title: "PRODUCTS",
      links: [
        { text: "Earphones", path: "/", icon: null, disabled: true },
        { text: "Headphones", path: "/", icon: null, disabled: true },
        { text: "Smartphones", path: "/", icon: null, disabled: true },
        { text: "Laptops", path: "/", icon: null, disabled: true },
      ],
    },
    {
      title: "WEBSITE?",
      links: [
        ...
        { text: "Privacy Policy", path: "/", icon: null, disabled: true },
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+1-212-456-7890", path: "/", icon: MailIcon, disabled: true },
        { text: "contact@example.com", path: "/", icon: PhoneIcon, disabled: true },
        { text: "794 Francisco, 94102", path: "/", icon: MapPinIcon, disabled: true },
      ],
    },
  ];
                  ...
                  {section.links.map((link, i) => (
                    <li key={i} className="flex items-center gap-2">
                      ...
                      {link.disabled ? (
                        <span
                          aria-disabled="true"
                          className="cursor-not-allowed select-none text-slate-400 opacity-75"
                          title="Unavailable"
                        >
                          {link.text}
                        </span>
